...
) : GObject<SandboxTabletop>(room), DragTarget
{
	...
	override fun canAccept(gObject: GObject<SandboxTabletop>): Boolean = gObject is Card || gObject is CardGroup

	override fun accept(gObject: GObject<SandboxTabletop>)
	{
		if (gObject is Card)
